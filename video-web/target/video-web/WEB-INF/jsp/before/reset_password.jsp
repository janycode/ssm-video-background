    ...
    <main>
        <div class="container">
            <form class="ma" action="${pageContext.request.contextPath}/user/resetPassword" method="post">
               <input type="hidden" name="email" value="${sessionScope.userAccount}"/>
                ...
                <div class="form_body">
                    ...
                    <input type="submit" style="margin:0px;width:100%;cursor: pointer;" value="提交" onclick="return commitForm()">
                </div>
