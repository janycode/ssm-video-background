...
<main>
    <div class="container">
        <form class="ma" action="${pageContext.request.contextPath}/user/validateEmailCode" method="post">
            <div class="form_header">
                ...
                <div class="form_back">
                    <a href="${pageContext.request.contextPath}/">返回首页登录</a>
                </div>
            </div>
            <div class="form_body">
                <input type="email" placeholder="请输入登录邮箱" name="email" value="${sessionScope.userAccount}">
                <input type="text" placeholder="请输入验证码" name="code">
                <input type="button" id="yzmBtn" value="获取验证码" style="cursor: pointer;">
