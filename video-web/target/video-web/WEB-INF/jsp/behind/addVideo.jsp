...
<head>
    ...
    <script type="text/javascript">
        ...
        //页面加载完毕之后就执行以下代码片段
        $(function () {
            var spearkerId = '${video.spearkerId}';
            $("#selectSpeaker li").each(function () {

                if ($(this).val() == spearkerId) {
            ...
            <div class="col-sm-10">
                <div class="input-group">
                    ...
                    <c:if test="${empty video.spearkerId}">
                        <input type="hidden" class="form-control" id="spearkerId" name="spearkerId" value="0">
                    </c:if>
                    <c:if test="${not empty video.spearkerId}">
                        <input type="hidden" class="form-control" id="spearkerId" name="spearkerId" value="${video.spearkerId}">
                    </c:if>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <c:if test="${video.id == null}">
                    <input type="number" class="form-control" value="0" name="playNum" readonly>
                </c:if>
                <c:if test="${video.id != null}">
                    <input type="number" class="form-control" value="${video.playNum}" name="playNum" readonly>
                </c:if>
            </div>
        </div>
