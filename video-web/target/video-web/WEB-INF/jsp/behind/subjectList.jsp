    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse"
            ...
            <ul class="nav navbar-nav">
                ...
                <li class="active"><a href="${pageContext.request.contextPath}/showCourseList">课程管理</a></li>
            </ul>
...
<div class="container" style="margin-top: 20px;">
    ...
    <table class="table table-bordered table-hover"
        ...
        <tbody>
        <c:forEach items="${page.pageDate}" var="speaker" varStatus="status">
            <tr>
...
<div class="container">
    <div class="navbar-right" style="padding-right: 17px">
        <abyg:page url="${pageContext.request.contextPath}/speaker/showSpeakerList"></abyg:page>
    </div>
</div>
</body>
