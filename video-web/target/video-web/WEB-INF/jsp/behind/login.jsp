...
<form>
    <div style="margin-top: 10%;">
        ...
        <img src="${pageContext.request.contextPath}/images/logo.png" class="img-responsive center-block"
             style="width: 20%" alt="Responsive image">
            ...
            <div class="row">
                ...
                <div class="form-group col-md-4" style=":1px solid #5CB85C">
                    ...
                    <input type="text" class="form-control" name="username" style="border:1px solid #5CB85C"
                           id="exampleInputEmail1" placeholder="用户名" value="root">
                </div>
                <div class="col-md-4"></div>
            </div>
            ...
            <div class="row">
                ...
                <div class="form-group col-md-4">
                    ...
                    <input type="password" class="form-control" name="password" style="border:1px solid #5CB85C"
                           id="exampleInputPassword1" placeholder="密码" value="1234">
                </div>
                <div class="col-md-4"></div>
